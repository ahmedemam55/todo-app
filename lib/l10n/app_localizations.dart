...
abstract class AppLocalizations {
  ...
  /// No description provided for @to_do_list.
  ///
  ...
  /// No description provided for @enter_your_task_title.
  ///
  /// In en, this message translates to:
  /// **'Enter Your Task Title'**
  String get enter_your_task_title;

  /// No description provided for @enter_your_task_details.
  ///
  /// In en, this message translates to:
  /// **'Enter Your Task Details'**
  String get enter_your_task_details;
  ...
  /// No description provided for @this_is_title.
  ///
  /// In en, this message translates to:
  /// **'This Is Title'**
  String get this_is_title;
